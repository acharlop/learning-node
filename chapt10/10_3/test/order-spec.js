...
describe("Ordering Items", function() {
	...
	describe("Warehouse interaction", function() {
		...
		it("receives a tracking number", function() {
			...
			expect(this.callback.calledWith(11111111111)).to.equal(false)
		})
		...
		it("calls packageAndShip with the correct sku and quantity", function() {
			...
			expect(this.warehouse.packageAndShip.calledWith("AAA", 2)).to.equal(false)
			expect(this.warehouse.packageAndShip.calledWith("AAA", 3)).to.equal(false)
		})
	})
})